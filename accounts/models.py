...
#     name = models.CharField(max_length=200)
#     description = models.TextField(blank=True)
#     created_by = models.ForeignKey(User, on_delete=models.CASCADE, limit_choices_to={'role': 'PM'}, related_name='projects')
#     created_at = models.DateTimeField(auto_now_add=True)
#     updated_at = models.DateTimeField(auto_now=True)
...
#     employee = models.ForeignKey(User, on_delete=models.CASCADE, limit_choices_to={'role': 'EMPLOYEE'}, related_name='todos')
#     title = models.CharField(max_length=200)
#     description = models.TextField(blank=True)
#     status = models.CharField(max_length=15, choices=STATUS_CHOICES, default='PENDING')
#     date = models.DateField(default=timezone.now)
...
#     employee = models.ForeignKey(User, on_delete=models.CASCADE, limit_choices_to={'role': 'EMPLOYEE'}, related_name='daily_updates')
#     date = models.DateField(default=timezone.now)
#     update_text = models.TextField()
#     working_hours = models.DecimalField(
#         max_digits=4, 
...
#     employee = models.ForeignKey(User, on_delete=models.CASCADE, related_name='hours_summary')
#     pm = models.ForeignKey(User, on_delete=models.CASCADE, related_name='team_hours')
#     total_hours = models.DecimalField(max_digits=10, decimal_places=2, default=0)
#     last_updated = models.DateTimeField(auto_now=True)
